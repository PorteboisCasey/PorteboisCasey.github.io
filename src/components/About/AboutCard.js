        ...
        <Card.Body>
          <blockquote className="blockquote mb-0">
            <p style={{ textAlign: "justify" }}>
              ...
              <br />
              Je suis actuellement en BTS SIO option SLAM pour faire un diplome en <strong className="purple">cybersécurité </strong> ou <strong className="purple">devops </strong>.
              <br />
              <br />
              <br />
